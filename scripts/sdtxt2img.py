...
def sampleLoop(opt, model, sampler):
    ...
    sample_path = os.path.join(outpath, "txt2img-images", time.strftime("%Y-%m-%d %H-%M-%S"))
    grid_path = os.path.join(outpath, "txt2img-grids", time.strftime("%Y-%m-%d %H-%M-%S"))
